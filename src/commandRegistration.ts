...
import { formatPerspectiveJsonCommand } from './commands/formatPerspectiveJson';
...
export function registerCommands(context: vscode.ExtensionContext, dependencyContainer: DependencyContainer, subscriptionManager: any) {
	...
	subscriptionManager.add(vscode.commands.registerCommand('ignition-flint.format-perspective-json', formatPerspectiveJsonCommand));
